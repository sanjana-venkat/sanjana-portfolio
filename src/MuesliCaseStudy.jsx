...
export function MuesliStudy() {
  return <article className={`work-case-study h-full w-full min-w-0 max-w-full overflow-x-hidden overflow-y-auto bg-white text-[#161513] ${FONT}`}><div className="mx-auto w-full min-w-0 max-w-[1080px] px-5 py-10 sm:px-10 sm:py-16">
    ...
    <Section eyebrow="The problem" title="The product was doing a lot. The experience showed all of it at once.">
      ...
      <div className="mt-10 grid gap-4 sm:grid-cols-2"><div><Image src="/muesli-v1-product.png" alt="Muesli V1 product screens with a flat dark navigation structure" /><p className="mt-3 text-[12px] font-semibold uppercase tracking-[0.08em] text-[#756D67]">V1 · Every area competed for attention</p></div><div><Image src="/muesli-still-01.png" alt="Final light Muesli workspace with a persistent recording action" /><p className="mt-3 text-[12px] font-semibold uppercase tracking-[0.08em] text-[#B6632C]">Final direction · Recording stays visible</p></div></div>
    </Section>
    ...
    <Section eyebrow="Onboarding" title="The first goal was one successful dictation">
      ...
      <div className="mt-10 space-y-8"><div><p className="mb-3 text-[12px] font-semibold uppercase tracking-[0.08em] text-[#756D67]">V1 · Setup presented the technical system first</p><Image src="/muesli-v1-onboarding.png" alt="Muesli V1 onboarding flow for model, accessibility and shortcut setup" /></div><div><p className="mb-3 text-[12px] font-semibold uppercase tracking-[0.08em] text-[#756D67]">V2 exploration · Permissions became a guided sequence</p><Image src="/muesli-v2-onboarding.png" alt="Muesli V2 onboarding exploration with guided permissions and a live shortcut test" /></div><div><p className="mb-3 text-[12px] font-semibold uppercase tracking-[0.08em] text-[#B6632C]">Final direction · The light visual system came after this exploration</p><Placeholder compact>TODO: Export the final light onboarding sequence from Figma</Placeholder></div></div>
    </Section>
    ...
    <Section eyebrow="The broader experience" title="I redesigned the daily product, not only the setup">
      ...
      <div className="mt-10 grid gap-4 sm:grid-cols-2"><div><p className="mb-3 text-[12px] font-semibold uppercase tracking-[0.08em] text-[#756D67]">V1 product</p><Image src="/muesli-v1-product.png" alt="Muesli V1 Insights and Dictionary screens" /></div><div><p className="mb-3 text-[12px] font-semibold uppercase tracking-[0.08em] text-[#756D67]">V2 exploration, before the final light system</p><Image src="/muesli-v2-product.png" alt="Muesli V2 Meetings, Insights and Dictionary exploration" /></div></div>
      <div className="mt-16 space-y-16"><Feature title="Dictations" copy="A clearer starting state, a reminder that everything stays on the Mac, a visible recording control and history that is easier to scan." image="/muesli-history.webp" alt="Final Muesli dictation history in the light visual system" /><Feature title="Meetings" copy="Stronger browsing hierarchy, clearer filters and meeting notes that are easier to read and return to." reverse placeholder="TODO: Export final Meetings screen from Figma" /><Feature title="Insights" copy="A bento-style view of activity, streaks, common words and the apps where someone dictates most." image="/muesli-final-insights.png" alt="Final light Muesli Insights dashboard with activity rings, weekly captures and top apps" /><Feature title="Dictionary" copy="A more useful way to add, review and edit the names or words the model should understand." reverse placeholder="TODO: Export final Dictionary screen from Figma" /></div>
    ...
    <Section eyebrow="Visual system" title="Making a technical product feel warm">
      ...
      <div className="mt-10 grid gap-4 lg:grid-cols-[1.45fr_0.55fr]"><Image src="/muesli-final-insights.png" alt="Final oat, brown and sage Muesli visual system applied to Insights" /><div className="grid gap-4"><Image src="/muesli-navigation.webp" alt="Final Muesli navigation styling and active states" /><Image src="/muesli-record-control.webp" alt="Final Muesli floating recording control and keyboard shortcut guidance" /></div></div>
    </Section>
